...
const upload = require('../../../middleware/storages');
const Project = require('../../../models/testing/Project');
var fs = require('fs');
const { htmlParse, tagsTable } = require('../../../utils/htmlParse');
...
router.post(
  ...
  async (req, res) => {
    ...
    const domonTree = await htmlParse(filePath);
    ...
    const newProject = new Project({
      ...
      amount,
      image,
      fileGraph: stringify(domonTree),
      fileTable: tagsTable([domonTree]),
      ...(req.file && { file: filePath })
    });
